...
import { FormProvider, RegisterOptions, useForm, useFormContext, UseFormRegister, UseFormReturn } from 'react-hook-form'
...
const useFormField = (id: string) => {
  ...
  const showError = Boolean((hasSubmitted || formState.touchedFields[id]) && error)
